    ...
    (() => {
            ...
            constructor(t = {}) {
                ...
                (h.current = this),
                    ...
                    (this.windowGyroWrapper =
                        this.windowGyroWrapper.bind(this)),
                ...
                if (
                    ...
                    const t = this.el;
                    if (
                        ((this.el = ((s = t), document.querySelector(s))),
                        !this.el)
                    )
            ...
            prepareEl() {
                ...
                for (t = 0; t < this.el.children.length; t++)
                    (e = this.el.children[t]),
                        ...
                        "auto" === getComputedStyle(e).zIndex &&
                            (e.style.zIndex = 1);
        ...
        class d extends l {
            ...
            genPoint(t, e, s) {
                let i;
                if (
                    (this.points || (this.points = []), this.options.showDots)
                ) {
            ...
            onInit() {
                ...
                for (let t = 0; t < 4; t++) {
                    ...
                    for (let t = 0; t < i.length; t++) {
                        let o = i[t],
                            n = 6 * (t + 1);
                        w.push(new p.Vector3(e * n, o, s * n)),
                            w.push(new p.Vector3(e * n, -o, s * n));
                    }
                }
            ...
            onUpdate() {
                ...
                return (
                    ...
                    this.sphere.material.color.set(r),
                    this.linesMesh2.material.color.set(h),
                    this.linesMesh3.material.color.set(h),
                    0.001 * this.t
                );
            }
            onMouseMove(t, e) {
                ...
                (s.tz = o * Math.sin(n)),
                    ...
                    (s.ty =
                        s.oy +
                        80 * (e - 0.5) * (this.options.mouseCoeffY || 1)),
                    this.rayCaster,
                    (this.rcMouseX = 2 * t - 1),
                    (this.rcMouseY = 2 * -t + 1);
            }
